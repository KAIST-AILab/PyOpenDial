...
from example_domains.chitchat.model.utils import openai_transformer_config


def get_model_config():
    default_config = openai_transformer_config()
    config = AttrDict({'bpe_vocab_path': './example_domains/chitchat/parameters/bpe.vocab',
                       'bpe_codes_path': './example_domains/chitchat/parameters/bpe.code',
                       'checkpoint_path': './example_domains/chitchat/checkpoints/last_checkpoint',
